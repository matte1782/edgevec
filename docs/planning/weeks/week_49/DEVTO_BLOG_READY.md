---
title: "Entity-Enhanced RAG in 300KB: No Neo4j, No GPT-4, Pure WASM"
published: false
description: "How EdgeVec implements entity-enhanced RAG entirely in-browser using Rust/WASM with named entity recognition and metadata boosting"
tags: webdev, rust, wasm, vectordatabase
cover_image: # TBD — add 1000x420px cover image URL before publishing
---
...
[EdgeVec](https://github.com/matte1782/edgevec) implements this in about 200 lines of Rust. Zero new dependencies. One struct, one method, one error type.
...
See it in action: **[Entity-RAG Demo](https://matte1782.github.io/edgevec/demo/entity-rag/index.html)**
...
Everything runs in your browser. Zero API calls. The WASM bundle is roughly 630KB uncompressed (~238KB gzipped). No server, no Docker, no API keys.
...
|:--------|:--------|:-------|:---------|
| Bundle size | ~630KB WASM | N/A (server) | N/A (server) |
...
In all of these scenarios, "spin up a Docker container" is not an option. A ~630KB WASM bundle with entity boosting, metadata filtering, and sub-millisecond search is.
...
Try the live demo: [Entity-RAG Demo](https://matte1782.github.io/edgevec/demo/entity-rag/index.html)
...
- [Live Demo](https://matte1782.github.io/edgevec/demo/entity-rag/index.html)
